...
class RecentQueriesTableViewController: UITableViewController {
    ...
    static var recentQueries: [String] = []
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return RecentQueriesTableViewController.recentQueries.count
    }

    
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "RecentQIdentifer", for: indexPath)
        
        cell.textLabel?.text = RecentQueriesTableViewController.recentQueries[indexPath.row]
